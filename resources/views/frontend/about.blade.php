...
@section('title', 'Về chúng tôi -  Hoa Hướng Dương')

@section('content')
<!-- Page Header Start -->
    <x-page-header title="Về chúng tôi" active="Về chúng tôi" />
<!-- Page Header End -->
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
                ...
                <h1 class="text-dark mb-4 display-5">{{ $settings['about_title'] ?? 'Chào mừng đến với Hoa Hướng Dương' }}</h1>
                <p class="text-dark mb-4">{{ $settings['about_content'] ?? 'Chúng tôi cam kết mang lại môi trường giáo dục tốt nhất cho con em bạn.' }}</p>
                <div class="row mb-4">
                    <div class="col-lg-6">
